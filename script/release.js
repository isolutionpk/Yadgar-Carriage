...
function zipAssets () {
  ...
  const zipAssets = [{
    name: 'yadgar-carriage-mac.zip',
    path: path.join(outPath, 'Yadgar Carriage-darwin-x64', 'Yadgar Carriage.app')
  }, {
    name: 'yadgar-carriage-windows.zip',
    path: path.join(outPath, 'Yadgar Carriage-win32-ia32')
  }, {
    name: 'yadgar-carriage-linux.zip',
    path: path.join(outPath, 'Yadgar Carriage-linux-x64')
  }]
